...
public class OnDeviceLimitProviderService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            first.setStartHour(11);
            first.setStartMinute(0);
            first.setEndMinute(0);
            first.setEndHour(13);
            LimitSchedule second = new LimitSchedule();
            second.setDayNumber(day);
            second.setWeekNumber(2);
            second.setStartHour(11);
            second.setEndHour(13);
            second.setStartMinute(0);
            second.setEndMinute(0);
            LimitSchedule third = new LimitSchedule();
            third.setDayNumber(day);
            third.setWeekNumber(3);
            third.setStartHour(11);
            third.setEndHour(13);
            third.setStartMinute(0);
            third.setEndMinute(0);
            LimitSchedule fourth = new LimitSchedule();
            fourth.setDayNumber(day);
            fourth.setWeekNumber(4);
            fourth.setStartHour(11);
            fourth.setEndHour(13);
            fourth.setStartMinute(0);
            fourth.setEndMinute(0);
