...
public class WatchZoneActivity extends AppCompatActivity implements OnMapReadyCallback,
        GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    private static final String TAG = WatchZoneActivity.class.getSimpleName();
        ...
        if (fragment == null) {
            fragment = new CreateAlarmLabelDialogFragment().newInstance(
                ...
                public void onLabelCreated(String label) {
                    mLabel = label;
                    long uid = WatchZoneRepository.getInstance(WatchZoneActivity.this).createWatchZone(
    ...
    private class ScanTask extends AsyncTask<Void, SweepingAddress, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            LimitDbHelper limitHelper = new LimitDbHelper(WatchZoneActivity.this);
            if (isCancelled()) {
                return null;
            }
            ...
            for (int i = 0; i < latLngs.size(); i++) {
                ...
                String add = LocationUtils.getAddressForLatLnt(WatchZoneActivity.this,
                        latLng);
